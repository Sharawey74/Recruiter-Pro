...
class TestCrossValidator:
    ...
    def test_cross_validate_with_scoring(self, sample_data, simple_model):
        ...
        scores = cv.evaluate_cv_performance(simple_model, X.values, y.values, scoring="f1")
    ...
    def test_learning_curve_basic(self, sample_data, simple_model, tmp_path):
        ...
        result = cv.plot_learning_curves(simple_model, X.values, y.values, model_name="TestModel")
    ...
    def test_reproducibility_with_random_state(self, sample_data, simple_model):
        ...
        np.testing.assert_array_equal(scores1["scores"], scores2["scores"])
