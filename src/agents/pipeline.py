...
class MatchingPipeline:
    ...
    def process_cv_for_job(
        self, cv_file_path: str, job: JobPosting, generate_explanation: bool = True
    ) -> MatchResult:
        """
        ...
        try:
            ...
            logger.info(
                f"[OK] Pipeline complete in {processing_time:.0f}ms - Decision: {decision.decision.value.upper()}"
            )
